...
# Data Analysis Notes
Please see the MiniPOD_HeaderLog.yaml for associated headers for each version! Not included in this log are crosstalk headers. That is to come, and it will be on the MiniPOD Wireless HeaderLog just so that it doesn't confuse anyone! It will be updated into a singular file in the future!
...
| V3.4.0        | Crosstalk!! | Percy & Julia | Jan 15, 2026   | Enables crosstalk with XPOD for B404x transmission	|
